...
class IntroScene(Scene):    
    ...
    def render(self):
        ...
        # Draw Title
        self.addText('WWII Night Fighter RADAR Interception', 285, 20, Colours.GREEN, Colours.BLACK, 32)  

        # Top row

        # Draw 'What is RADAR?'image and text
        self.getGame().screen.blit(self.__whatIsRadarSprite, (30, 70))
        self.addText('What is RADAR?', 30, 230, Colours.GREEN, Colours.BLACK, 24) 

        if self.__selectedOption == Enums.IntroOptions.WHAT_IS_RADAR:
            selectedRect = pygame.Rect(20, 60, 240, 195)
            pygame.draw.rect(self.getGame().screen, Colours.RED, selectedRect, 2)

        # Draw AI MK IV image and text
        self.getGame().screen.blit(self.__AI_Mk_IV_Sprite, (300, 70))
        self.addText('AI MK IV', 300, 230, Colours.GREEN, Colours.BLACK, 24) 
        ...
        self.getGame().screen.blit(self.__ASV_Mk_II_Sprite, (750, 70))
        self.addText('ASV MK II', 750, 230, Colours.GREEN, Colours.BLACK, 24) 
        ...
        self.getGame().screen.blit(self.__airborneIntercept_Sprite, (30, 270))
        self.addText('Airborne Intercept', 30, 430, Colours.GREEN, Colours.BLACK, 24)
        ...
        self.getGame().screen.blit(self.__AI_MK_VIII_Sprite, (300, 270))  
        self.addText('AI MK VIII', 300, 430, Colours.GREEN, Colours.BLACK, 24)
        ...
        self.getGame().screen.blit(self.__AI_MK_X_Sprite, (750, 270))
        self.addText('AI MK X', 750, 430, Colours.GREEN, Colours.BLACK, 24)
