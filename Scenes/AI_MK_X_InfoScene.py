...
class AI_MK_X_InfoScene(Scene):
    ...
    def renderPage1(self):
        ...
        self.add_text('the scanning and display methods differ considerably. A British MK IX system was also developed that was more sophisticated,', 60, 360, Colours.YELLOW, Colours.BLACK, 28)
        self.add_text('as it had \'lock and follow\' capabilities, but problems in meeting production quantities and timescales required prevented it from', 60, 390, Colours.YELLOW, Colours.BLACK, 28)
        ...
        self.get_game().screen.blit(self.__AI_MK_X_Sprite, (950, 120))
    ...
    def renderPage2(self):
        ...
        self.add_text('tilted up and down, which effectively traces out a helix in the sky, much like looking out from', 60, 150, Colours.YELLOW, Colours.BLACK, 28)
        self.add_text('the centre of a coil spring. The rear half of the scan, some 210 degrees, is blanked off, as its', 60, 180, Colours.YELLOW, Colours.BLACK, 28)
        self.add_text('field of view is interrupted by the structure of the aircraft. The presentation of the information', 60, 210, Colours.YELLOW, Colours.BLACK, 28)
    ...
    def renderPage3(self):
        ...
        self.add_text('1', 778, 80, Colours.YELLOW, Colours.BLACK, 38)
        self.get_game().screen.blit(self.__AI_MK_X_1_Sprite, (778, 120))
        self.add_text('2', 778, 450, Colours.YELLOW, Colours.BLACK, 38)
        self.get_game().screen.blit(self.__AI_MK_X_2_Sprite, (778, 490))
        self.add_text('3', 1028, 450, Colours.YELLOW, Colours.BLACK, 38)
        self.get_game().screen.blit(self.__AI_MK_X_3_Sprite, (1028, 490))
