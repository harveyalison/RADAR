...
class AI_MK_IV_InfoScene(Scene):
    ...
    def renderPage1(self):
        ...
        self.add_text('This was the first night fighter RADAR to enter service in', 20, 120, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('late 1940. It was introduced as a response to the change of', 20, 150, Colours.GREEN, Colours.BLACK, 28)
        ...
        self.add_text('one for starboard and the other two for up and down', 20, 450, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('directions, all being at an angle of about 35 degrees to the centre line of the aircraft. Depending on the', 20, 480, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('position of the target, each aerial would receive a different signal level. The signal levels were displayed', 20, 510, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('on the indicator unit after passing though a receiver. The equipment was installed in the position normally', 20, 540, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('occupied by the rear gunner in the Blenheim. The operator sat facing the rear looking into the indicator,', 20, 570, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('the receiver being fitted vertically at the operator\'s side. Information as to the course that the pilot was to', 20, 600, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('fly to intercept the target was passed to the pilot via the intercom system.', 20, 630, Colours.GREEN, Colours.BLACK, 28)
    ...
    def renderPage2(self):
        ...
        self.add_text('indicator unit. The receiver also contained the power supplies for the indicator unit.', 20, 420, Colours.GREEN, Colours.BLACK, 28)
        self.add_text('', 20, 450, Colours.GREEN, Colours.BLACK, 28)
